...
var SCHEMA_SETUP_MARK = 'schema_setup_v3'; // v3: nominees 增加 proud_decision / ability_tag
...
async function doEnsureSchema() {
  ...
  // 信息收集两问（最自豪的管理决策 / 能力标签）：老库通过 ALTER 补齐
  ...
  var result = await db.execute({
    sql: `
      INSERT INTO nominees (
        ...
        proud_decision, ability_tag, auth_agreed,
